...
# print len(Ls_temp_labels), type(Ls_temp_labels)
# print len(Ls_temp_centers), type(Ls_temp_centers)
# print Ls_temp_labels
# print Ls_temp_centers
...
# print type(label_img), label_img
...
out_path = '/home/brain/workingdir/data/dwi/hcp/' \
           ...
           'result20vs45/CC_fib_ncut_new_sample1000_set0-1_%s.tck'
