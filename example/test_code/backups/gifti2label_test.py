...
if __name__ == '__main__':
    label_gifti = '/home/brain/workingdir/HCP_label/brain_label/fsaverage.label.R.164k_fsavg_R.label.gii'
    white = '/home/brain/workingdir/HCP_label/brain_label/rh.white'
    label_label = '/home/brain/workingdir/data/dwi/hcp/preprocessed/' \
                  'response_dhollander/100408/my_labels/fsavg/fsavg_rh_PIT.label'

    gifti2label(label_gifti, white, 22, label_label)
